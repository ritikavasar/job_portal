...
1. Clone the repo:
   ```sh
   git clone https://github.com/ritikavasar/job_portal.git
   ```
...
Ritik Kumar - [GitHub](https://github.com/ritikavasar)

Project Link: (https://github.com/ritikavasar/job_portal.git)
